...
def train_node_classifier():
    ...
    print("##############")
    print(f"{DATASET_DIR}/{VALID_SUB_GRIDS}/{cryodata}")
    ...
    # valid_loader = DataLoader(dataset=val_data, batch_size=BATCH_SIZE, shuffle=False, pin_memory=False, num_workers=args.num_dataloader_workers)
    # test_loader = DataLoader(dataset=test_data, batch_size=BATCH_SIZE, shuffle=False, pin_memory=False, num_workers=args.num_dataloader_workers)
